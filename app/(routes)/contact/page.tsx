...
const Contact = () => {
  return (
    <div className='grid justify-center mt-16 mb-15'>
        <p className='w-[750px] text-center'>Hey there, Fashionista! I am happy, you want to get in touch. Whether you have a style question or just want to chat about the latest trends, I am here for you! Feel free to reach out through any of the snazzy methods</p>
        <br />
        ...
        <form className="fform">
                    ...
                    <div className="fflex">
                        <label>
                            <input required placeholder="" type="text" className="iinput"/>
                    ...
                    <label>
                        <input required placeholder="" type="email" className="iinput"/>
                        <span>email</span>
                    </label> 
                        
                    <label>
                        <input required type="tel" placeholder="" className="iinput"/>
                        <span>contact number</span>
                    </label>
                    <label>
                        <textarea required  placeholder="" className="iinput01"></textarea>
                        <span>message</span>
                    </label>
                    
                    <button className="ffancy" >
                    <span className="ttop-key"></span>
                    <span className="ttext">submit</span>
